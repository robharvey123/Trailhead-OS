...
type StatusKind = 'account' | 'contact' | 'enquiry' | 'invoice' | 'quote'
...
function formatStatusLabel(
  value: AccountStatus | ContactStatus | EnquiryStatus | InvoiceStatus | QuoteStatus | string
) {
  return value
    .split('-')
...
export default function StatusBadge({
  ...
  status: AccountStatus | ContactStatus | EnquiryStatus | InvoiceStatus | QuoteStatus | string
  kind: StatusKind
  className?: string
}) {
  const classes =
