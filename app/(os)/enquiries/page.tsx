    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold text-white">Enquiries</h1>
          ...
          <div className="space-y-3">
            {enquiries.map((enquiry) => (
              <Link
                ...
                className="block rounded-3xl border border-[#2A2A3A] bg-[#13131E] p-5 transition hover:border-[#2A2A3A]"
              >
