...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const allowed = ['invoice_number', 'account_id', 'contact_id', 'direction', 'status', 'issue_date', 'due_date', 'subtotal', 'tax_rate', 'tax_amount', 'discount_amount', 'total', 'amount_paid', 'currency', 'line_items', 'notes', 'payment_terms']
